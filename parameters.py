"""Parameters for the BEBOP code (version 1.0)
...
def BEBOP_Pair(Atom1,Atom2, res_strain = False):
    """Fitted atom-pair parameters used in the BEBOP equation (i.e., beta, zeta, R_sigma and D_AB)
       ...
       R_sigma: :obj:'np.float'
           Classical turning distance (i.e., E_tot \approx E_short )  
       D_AB: :obj:'np.float'
...
def BEBOP_Atom(Atom):
    """Single-atom parameters used in the BEBOP equation (i.e., n_2s, excitation energies from 2s to 2p)
