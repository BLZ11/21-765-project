"""Main subroutine that computes all BEBOP-1 calculations
   total_E:: compute the BEBOPG1 atomization energy with zero-point vibrational energy (ZPVE) at 0 K
   bond_E:: compute bond energy tables
   sort_bondE:: sort the bond energies in order
   resonance_E:: get the computed resonance energy
   strain_E:: get the computed resonance energy
   """
...
class BEBOP: # BEBOP class
    ...
    def bond_E(self, NetBond = True, GrossBond = False, Composite = False, TotalE=False, sig_pi = False):
    ...
    def resonance_E(self,Atom_Positions, CC_single= 0.7874, CC_double= 1.1958, CN_star= 0.6941,
              CN_double= 1.0699, double_CN = 0.7644):
